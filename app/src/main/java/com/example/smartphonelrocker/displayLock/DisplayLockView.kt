 ...
 */
class DisplayLockView @JvmOverloads constructor(
    ctx: Context,
    ...
    companion object {
        ...
        fun create(context: Context) =
            View.inflate(context, R.layout.display_lock_view, null) as DisplayLockView
    }
...
//            or WindowManager.LayoutParams.FLAG_DIM_BEHIND // 背後暗くする
